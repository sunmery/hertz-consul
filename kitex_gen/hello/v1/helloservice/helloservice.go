...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*v1.HelloService)(nil)
...
func helloHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(v1.HelloService).Hello(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *HelloArgs:
		success, err := handler.(v1.HelloService).Hello(ctx, s.Req)
		if err != nil {
			return err
		}
...
var HelloArgs_Req_DEFAULT *v1.Req

func (p *HelloArgs) GetReq() *v1.Req {
	if !p.IsSetReq() {
...
func (p *HelloResult) GetSuccess() *v1.Res {
	if !p.IsSetSuccess() {
...
func (p *kClient) Hello(ctx context.Context, Req *v1.Req) (r *v1.Res, err error) {
	var _args HelloArgs
	_args.Req = Req
